...
class vehicalDetailsAdmin(admin.ModelAdmin):
    ...
    list_display = ('id',"customer_name","account_no","center","executive","segment","product_name","new_vehicle_number","engine_number","chasis_number","created_at")
    list_display_links = ('id',"customer_name","account_no","center","executive","segment","product_name","new_vehicle_number","engine_number","chasis_number","created_at")
    ordering = ('-id'),
    list_filter = ('center'),
